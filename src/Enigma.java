...
public class Enigma extends Substitutor{
    ...
    public char step(char letter) {
        ...
        char ref,forwardResult,finalResult;
        ...
        forwardResult= forwardTranslate(letter);
        ref = reflector.translate(forwardResult);
        finalResult=reverseTranslate(ref);
    ...
    public char reverseTranslate(char letter) {
        char one, two, three;
        three = left.reverseTranslate(letter);
        two = middle.reverseTranslate(three);
        one = right.reverseTranslate(two);
        return plugboard.reverseTranslate(one);
    }
}
